...
public class TestController {
	...
	public @ResponseBody ApiResponse testGetResponse(@PathVariable String userId){
	...
	public @ResponseBody ApiResponse testPostResponse(@RequestHeader("Accept-Encoding") String encoding,@RequestHeader("Content-Type")String contentType,String param,HttpServletRequest request){
	...
	public @ResponseBody ApiResponse testPostResponseRequestJson(@RequestBody UserCustomer userCustomer){
